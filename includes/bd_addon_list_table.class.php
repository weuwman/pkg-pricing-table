...
class Boatdeck_Addon_List_Table extends WP_List_Table
{
    /**
    ...
    function process_bulk_action()
    {
        ...
        $addons_table = $table_prefix . 'addons';
        ...
        if ('delete' === $this->current_action()) {
            ...
            if (!empty($ids)) {
                ...
                $wpdb->query("DELETE FROM $addon_features_table WHERE addon_id IN($ids)");
            }
        }
    }
    /**
    ...
    {
        global $wpdb, $table_prefix;
        $table_name = $table_prefix . 'addons'; // do not forget about tables prefix
